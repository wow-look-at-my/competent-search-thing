...
// xmlUnescaper reverses xmlEscape (&amp; last, so a literal "&amp;lt;"
...
// xmlUnescape decodes a plist <string> text node emitted by xmlEscape
// (the repair log's old-path extraction; see plistProgram).
