...
func TestConfigSchemaRejectsInvalid(t *testing.T) {
	...
	cases := map[string]string{
		...
		"priors key typo":                  `{"search":{"priors":{"disabld":true}}}`,
		"non-bool priors disabled":         `{"search":{"priors":{"disabled":"yes"}}}`,
		"non-object priors":                `{"search":{"priors":true}}`,
		"old priors enabled key":           `{"search":{"priors":{"enabled":true}}}`,
		"unknown priors key":               `{"search":{"priors":{"disabled":true,"halfLifeDays":7}}}`,
		"priors misspelled in search":      `{"search":{"prios":{"enabled":true}}}`,
		"arbiter key typo":                 `{"search":{"arbiter":{"disabld":true}}}`,
		"non-bool arbiter disabled":        `{"search":{"arbiter":{"disabled":"yes"}}}`,
		"non-object arbiter":               `{"search":{"arbiter":true}}`,
		"old arbiter enabled key":          `{"search":{"arbiter":{"enabled":true}}}`,
		"unknown arbiter key":              `{"search":{"arbiter":{"disabled":true,"minPicks":10}}}`,
		...
		"old telemetry enabled key":        `{"search":{"telemetry":{"enabled":true}}}`,
